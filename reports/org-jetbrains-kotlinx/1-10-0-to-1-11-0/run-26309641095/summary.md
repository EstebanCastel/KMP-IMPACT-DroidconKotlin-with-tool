...
- **Static impact:** 121 files (62 direct / 59 transitive-or-expect-actual)
...
| `/tmp/output/phase1/before/android/src/main/java/co/touchlab/droidcon/android/MainActivity.kt` | direct | main | 131 | 6 |
